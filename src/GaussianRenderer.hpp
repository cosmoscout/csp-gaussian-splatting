...
/// This class manages drawing of a single radiance field. It provides two ways for drawing the
/// given radiance field: Either using a very simple approach using instanced rendering of tiny
/// boxes, or via the splat raycasting developed for the original gaussian splatting paper.
class GaussianRenderer : public IVistaOpenGLDraw {
 public:
  ...
  void configure(Plugin::Settings::RadianceField const& settings,
